 ...
 */
public class ExcelNameData_map {
    /**
     * 读取某个excel文件数据，并放入Map中返回
     * @return Object
     */
    public static HashMap<String, String>[][] testData(String filepath, String sheetname){
        ...
        for (int c=0;c<columns;c++){
            String cellvalue=ExcelData.getCellValue(sheet,0,c);
        ...
        for(int r=1;r<rowTotalNum;r++){
            for (int c=0;c<columns;c++){
                String cellvalue=ExcelData.getCellValue(sheet,r,c);
    ...
    public static String getCellValue(Sheet sheet,int rowNum,int cellNum) {
        ...
        String value = ExcelData.getCellValue2(cell);
        return value;
    }
    ...
    public Object[][]data(){
        ...
        return excelCase.testData(file,1);
    }
