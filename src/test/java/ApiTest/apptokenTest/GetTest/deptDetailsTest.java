...
public class deptDetailsTest {
    ...
    public void appDeptdetailsTest(HashMap<String, String> data) throws Exception {
        ...
        //发送get请求
        JSONObject res= apptokenGetPrep.getRequests("APIurl","deptDetails",data,sign,access_token);
