 ...
 */
public class qy_usersTest {
    @DataProvider(name="testData")
    public Object[][] data() throws Exception {
        Object[][] testdata= EnvInit.EnvInitTest("E:\\API.xlsx","qy_users");
        return testdata;
    }

    @Test(dataProvider = "testData")
    public void qy_usersTestPost(HashMap<String, String> data) throws Exception {
        //签名
        String sign= userSign.userSign(data);
        //获取apptoken
        String access_token= accessToken.getUsertoken();
        //发送post请求
        JSONObject res= apptokenPostPrep.postRequestsToJson("APIurl","qy_users",data,sign,access_token);
