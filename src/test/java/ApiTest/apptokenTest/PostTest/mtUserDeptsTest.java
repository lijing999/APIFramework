...
public class mtUserDeptsTest {
    ...
    public void mtUserDeptsPost(HashMap<String, String> data) throws Exception {
        //签名
        String sign= userSign.userSign(data);
        //获取apptoken
        String access_token= accessToken.getUsertoken();
        //发送post请求
        JSONObject res= apptokenPostPrep.postRequestsToJson("APIurl","mtUserDepts",data,sign,access_token);
