...
public class orgs_trustedOrgsTest {
    ...
    public void orgs_trustedOrgsTest(HashMap<String, String> data) throws Exception {
        //签名
        String sign= userSign.userSign(data);
        //获取apptoken
        String access_token= accessToken.getUsertoken();
        //发送get请求
        JSONObject res= usertokenGetPrep.getRequests("APIurl","orgs_trustedOrgs",data,sign,access_token);
        //结果校验
