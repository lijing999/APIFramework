...
public class usergroupsTest {
    ...
    public void usergroupsTest(HashMap<String, String> data) throws Exception {
        //签名
        String sign= userSign.userSign(data);
        //获取apptoken
        String access_token= accessToken.getUsertoken();
        //发送get请求
        JSONObject res= usertokenGetPrep.getRequests("APIurl","usergroups",data,sign,access_token);
