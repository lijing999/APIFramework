...
public class appRolesTest {
    ...
    public Object[][] data() throws Exception {
        Object[][] testdata= EnvInit.EnvInitTest("E:\\API.xlsx","appRoles");
        return testdata;
    }

    @Test(dataProvider = "testData")
    public void appRolesTestPost(HashMap<String, String> data) throws Exception {
        //签名
        String sign= userSign.userSign(data);
        //获取apptoken
        String access_token= accessToken.getUsertoken();
        //发送post请求
        JSONObject res= usertokenPostPrep.postRequestsToJson("APIurl","appRoles",data,sign,access_token);
        //结果校验
