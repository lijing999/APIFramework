 ...
 */
public class userBizDeptTest {
    @DataProvider(name="testData")
    public Object[][] data() throws Exception {
        Object[][] testdata= EnvInit.EnvInitTest("E:\\API.xlsx","userBizDept");
        return testdata;
    }

    @Test(dataProvider = "testData")
    public void userBizDeptTestPost(HashMap<String, String> data) throws Exception {
        //签名
        String sign= userSign.userSign(data);
        //获取apptoken
        String access_token= accessToken.getUsertoken();
        //发送post请求
        JSONObject res= usertokenPostPrep.postRequestsToJson("APIurl","userBizDept",data,sign,access_token);
        //结果校验
